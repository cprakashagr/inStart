...
public class StartButton extends JDialog implements Runnable{
...
//		g.drawString("Hello", 10,10);
		...
		exist = true;
		setIconImage(Toolkit.getDefaultToolkit().getImage(StartButton.class.getResource("/Images/bin-full.png")));
		...
		label_1.setIcon(new ImageIcon(StartButton.class.getResource("/Images/logout2.png")));
		...
		label_2.setIcon(new ImageIcon(StartButton.class.getResource("/Images/logoff1.png")));
		...
		searchIcon.setIcon(new ImageIcon(StartButton.class.getResource("/Images/Search2.png")));
...
//				toggleButton.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		toggleButton.setIcon(new ImageIcon(StartButton.class.getResource("/Images/settingsIcon.png")));
		toggleButton.setBorder(new LineBorder(new Color(255, 255, 255)));
	...
	public void run() {
		...
		try {
			...
			while (true) {
				...
				StartButton.timeLabel.setText(now);
				Thread.sleep(1000);
			}
